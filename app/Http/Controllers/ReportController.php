    ...
    public function index(Request $request)
{
    ...
    public function addComment(Request $request, $id)
    {
        ...
        $badWords = ['memek', 'kontol', 'anjing', 'bangsat', 'tolol', 'babi', 'sialan', 'goblok', 'jancok', 'asu', 'bajingan', 'setan', 'perek', 'pelacur', 'pelacuran', 'bangke', 'kotoran', 'bajingan', 'babi ngepet', 'babi hutan', 'babi ngepet', 'babi hutan', 'babi ngepet', 'babi hutan', 'babi ngepet', 'babi hutan'];
