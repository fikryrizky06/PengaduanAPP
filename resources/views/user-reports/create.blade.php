    ...
    <div class="py-12 bg-gray-100 min-h-screen">
        <div class="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-xl">
            ...
            <form action="{{ route('user.report.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label for="description" class="block font-medium text-gray-700 mb-1">Deskripsi Laporan</label>
                ...
                <div>
                    <label for="type" class="block font-medium text-gray-700 mb-1">Jenis Laporan</label>
                ...
                <div class="flex justify-between">
                    <a href="{{ route('report.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">Batal</a>
                    <button type="submit" class="inline-flex items-center px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition">Kirim</button>
                </div>
            </form>
        </div>
    </div>
